<?php include 'includes/header.php' ?>
    <div class="impressum-seite">
        <div class="container">

            <h1 class ="text-uppercase">Impressum </h1>
            <br>
            <div class="impressum-Anschrift">
                <h4>Anschrift:</h4> Mediationsbüro Klein/Volmer<br>
                RAin Marion Klein<br>
                Friedrichstr. 32<br>
                D-53111 Bonn<br>
                <br>
                Telefon: +49 228 71 01 75 00<br>
                Telefax: +49 228 71 01 74 90<br>
                <br>
                E-Mail: info@kanzlei-marion-klein.de<br>
                Internet: www.mediator-in-bonn.de<br>
                <br>
            </div>
            <h4>Inhaltlich Verantwortlicher:</h4> Marion Klein und Annett Volmer (Anschrift wie oben)<br>
            <br>
            <h4>Haftungshinweis:</h4> Trotz sorgfältiger inhaltlicher Kontrolle übernehmen wir keine Haftung für die
            Inhalte externer Links. Für den Inhalt der verlinkten Seiten sind ausschließlich deren Betreiber
            verantwortlich. Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz: 292363140 .<br>
            <br>
            <h4>Urheberrecht / Copyright:</h4> Die hier veröffentlichten Beiträge sind urheberrechtlich geschützt (vgl.
            hierzu auch LG Hamburg, Urteil vom 31.01.2007 - Az. 308 O 793/06 - PDF). Der Inhalt dieser Homepage darf
            ohne schriftliche Genehmigung der Herausgeber außer zum eigenen Gebrauch weder bearbeitet, übersetzt,
            vervielfältigt oder verbreitet, noch sonst gewerblich auf Druckmedien oder elektronischem Wege vertrieben
            werden. Unter dieses Verbot fällt auch die gewerbliche Vervielfältigung per Kopie, die Aufnahme in
            elektronische Datenbanken und Online-Dienste sowie die gewerbliche Vervielfältigung auf CD-ROM oder
            Diskette. Die Informationen dieser Homepage sind kein Rechtsrat und können eine rechtskundige Beratung
            keinesfalls ersetzen. Für Fehler im Text übernehmen wir keine Haftung.<br>
            <br>
            <h4>Datenschutzgrundverordnung</h4>
            Diese Datenschutz-Information gilt für die Datenverarbeitung durch:<br><br>

            Verantwortlicher: Mediatorinnen: Marion Klein und Annett Volmer, E-Mail:
            info@kanzlei-marion-klein.de, Telefon: +49 (0) 228 71 01 75 00<br><br>

            Die betriebliche Datenschutzbeauftragte von Mediationsbüro Klein/Volmer ist unter der
            o.g. Anschrift, zu Hd. Frau Klein beziehungsweise unter info@kanzlei-marion-klein.de
            erreichbar.<br><br>

            <span class="impressum-num">1. Erhebung und Speicherung personenbezogener Daten sowie Art und Zweck von
                deren Verwendung</span><br><br>

            <span class ="impresum-alph">a) Beim Besuch der Website</span><strong><br><br></strong>

            Beim Aufrufen unserer Website www.mediator-in-bonn.de werden durch den auf Ihrem
            ...
            Nähere Erläuterungen dazu erhalten Sie unter den Ziff. 4 und 5 dieser Datenschutzerklärung.<br><br>

            <span class ="impresum-alph">b) Bei Nutzung unseres Kontaktformulars </span> <br><br>
            ...
            beantworten zu können. Weitere Angaben können freiwillig getätigt werden.<br><br>

            Die Datenverarbeitung zum Zwecke der Kontaktaufnahme mit uns erfolgt nach Art. 6 Abs. 1
            S. 1 lit. a DSGVO auf Grundlage Ihrer freiwillig erteilten Einwilligung.<br><br>
            ...
            <br><br>
            <span class="impressum-num">2. Weitergabe von Daten</span><br><br>

            Eine Übermittlung Ihrer persönlichen Daten an Dritte zu anderen als den im Folgenden
            aufgeführten Zwecken findet nicht statt.<br><br>

            Wir geben Ihre persönlichen Daten nur an Dritte weiter, wenn:<br><br>
            <ul>
            ...
            <span class="impressum-num">3. Cookies</span><br><br>
            ...
            keinen Schaden an, enthalten keine Viren, Trojaner oder sonstige Schadsoftware.<br><br>

            In dem Cookie werden Informationen abgelegt, die sich jeweils im Zusammenhang mit dem
            spezifisch eingesetzten Endgerät ergeben. Dies bedeutet jedoch nicht, dass wir dadurch
            unmittelbar Kenntnis von Ihrer Identität erhalten.<br><br>
            ...
            unserer Seite automatisch gelöscht.<br><br>
            ...
            sie getätigt haben, um diese nicht noch einmal eingeben zu müssen.<br><br>
            ...
            Zeit automatisch gelöscht.<br><br>

            Die durch Cookies verarbeiteten Daten sind für die genannten Zwecke zur Wahrung unserer
            berechtigten Interessen sowie der Dritter nach Art. 6 Abs. 1 S. 1 lit. f DSGVO erforderlich.<br><br>
            ...
            <span class="impressum-num">4. Betroffenenrechte</span>
            <br><br>
            ...
            <span class="impressum-num">5. Widerspruchsrecht </span><br><br>

            Sofern Ihre personenbezogenen Daten auf Grundlage von berechtigten Interessen gemäß
            Art. 6 Abs. 1 S. 1 lit. f DSGVO verarbeitet werden, haben Sie das Recht, gemäß Art. 21<br><br>
            ...
            Möchten Sie von Ihrem Widerrufs- oder Widerspruchsrecht Gebrauch machen, genügt eine E-Mail<strong>  info@kanzlei-marion-klein.de.</strong><br><br>

            <span class="impressum-num">6. Datensicherheit </span><br><br>
            ...
            Symbols in der unteren Statusleiste Ihres Browsers.<br><br>
            ...
            Entwicklung fortlaufend verbessert.<br><br>

            <span class="impressum-num">7. Aktualität und Änderung dieser Datenschutzerklärung</span><br><br>

            Diese Datenschutzerklärung ist aktuell gültig und hat den Stand Mai 2018.<br><br>
            ...
            jederzeit auf der Website unter https://www.mediator-in-bonn.de/datenschutz von Ihnen
